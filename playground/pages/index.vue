      ...
      <div class="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-8 border border-white/20 max-w-2xl mx-auto animate-slide-up">
        <div class="flex items-center space-x-4 mb-6">
          ...
          <div>
            ...
            <p class="text-gray-600">Welcome, {{ auth.currentUser?.username }}!</p>
          </div>
        </div>
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-gray-600">{{ auth.currentUser?.id }}</p>
              </div>
            </div>
            ...
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-gray-600">{{ auth.currentUser?.email }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-gray-600">{{ auth.currentUser?.username }}</p>
              </div>
            </div>
            ...
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-gray-600">{{ formatDate(auth.currentUser?.createdAt) }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h4 class="text-lg font-semibold text-gray-900 mb-2">JWT Security</h4>
            <p class="text-gray-600 text-sm">Secure authentication with JWT tokens and refresh tokens</p>
          </div>
          ...
          <div class="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h4 class="text-lg font-semibold text-gray-900 mb-2">Performance</h4>
            <p class="text-gray-600 text-sm">Optimized for Nuxt 3 with reactive composables</p>
          </div>
          ...
          <div class="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h4 class="text-lg font-semibold text-gray-900 mb-2">Configuration</h4>
            <p class="text-gray-600 text-sm">Simple and flexible configuration for all projects</p>
          </div>
        </div>
      </div>
    </div>
